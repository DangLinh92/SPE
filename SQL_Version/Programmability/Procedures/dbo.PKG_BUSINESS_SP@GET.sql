...
BEGIN TRY
		BEGIN
		    SET NOCOUNT OFF;  
			SELECT sp.CODE,ME.CODE_MERGED,sp.NAME_VI,sp.NAME_KR,sp.SPECIFICATIONS AS SPECIFICATION,sp.GL_ACCOUNT,spd.COST_CTR,V.NAME as VENDER_NAME,u.CODE AS UNIT, T.NAME AS TYPENAME--,SP.DESCRIPTION
