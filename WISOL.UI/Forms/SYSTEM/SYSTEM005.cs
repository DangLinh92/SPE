    ...
    public partial class SYSTEM005 : PageType
    {
        ...
        public override void InitializePage()
        {
            try
            {
                ...
                {
                    base.m_BindData.BindGridView(gcList,base.m_ResultDB.ReturnDataSet.Tables[0],false,"PASSWORD, REMARKS, USER_ROLE");
                    base.m_BindData.BindGridLookEdit(sltDepartment, base.m_ResultDB.ReturnDataSet.Tables[1],"DEPARTMENT", "DEPARTMENT");
                    sltDepartment.Select();
                    Init_Control();
                }
            }
            catch (Exception ex)
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Console.WriteLine(sltDepartment.EditValue.NullString());
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SYSTEM005.PUT_ITEM"
                    ...
                    , new string[] { Consts.PLANT,
                        ...
                        Consts.USER_INFO.Id,
                        sltDepartment.EditValue.NullString()
                    }
                    );
