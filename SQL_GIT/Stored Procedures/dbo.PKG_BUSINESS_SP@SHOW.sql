...
BEGIN TRY
		BEGIN
			...
			FROM [dbo].[EWIP_SPAREPART_UNIT] su
			     INNER JOIN EWIP_SPARE_PART sp ON su.SPARE_PART_CODE = sp.CODE AND su.DEPT_CODE = sp.SP_DEPT_CODE
			WHERE su.SPARE_PART_CODE = @A_CODE AND [UNIT_CODE] <> [UNIT_CODE_MIN] and sp.[SP_DEPT_CODE] = @A_DEPARTMENT;
		END
