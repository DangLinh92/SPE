...
BEGIN TRY
		BEGIN
		    SET NOCOUNT OFF;  
			SELECT [LOCATION_CODE] AS LOCATION,[CONDITION_CODE],[dbo].[CONVERT_UNIT](UNIT_ID,@A_UNIT,@A_SPARE_PART_CODE,@A_DEPT_CODE) * QUANTITY AS QUANTITY,0.0 AS QUANTITY_GET,@A_UNIT as UNIT,CASE WHEN [EXPIRED_DATE] = '2199-01-01' THEN NULL ELSE [EXPIRED_DATE] END AS [EXPIRED_DATE],TIME_IN,PO_NO
