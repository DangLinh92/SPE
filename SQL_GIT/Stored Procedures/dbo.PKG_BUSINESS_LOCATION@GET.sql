...
BEGIN TRY
		BEGIN
			...
			SELECT DISTINCT  lc.[CODE] AS LOCATION,[SPARE_PART_CODE],sp.NAME_VI,spc.NAME AS CONDITION_NAME,spl.UNIT_ID as UNIT,spl.QUANTITY,lc.STOCK_CODE AS KHO,spl.ID AS STT,spl.BARCODE, 1 as QUANTITY_PRINT_LABEL,
			          (CASE 
					       WHEN spl.[EXPIRED_DATE] = '2199-01-01' THEN null 
						   ELSE spl.[EXPIRED_DATE] END) AS EXPIRED_DATE,
					  [TIME_IN],DATEDIFF(WEEK,[TIME_IN],GETDATE()) AS INVENTORY_TIME,spl.PO_NO,O.[OPERATION_NAME] AS STAGE
