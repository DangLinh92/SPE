...
BEGIN TRY
		BEGIN
		    SET NOCOUNT OFF;  
			SELECT [SPARE_PART_CODE],SP.NAME_VI,[LOCATION_CODE_FROM],[LOCATION_CODE_TO],[CONDITION_CODE],[QUANTITY],[DEPT_CODE],[STOCK_CODE],T.[UNIT_ID],[EXPIRED_DATE],[TIME_IN],T.PO_NO,[DATE_MOVE],FORMAT ([DATE_MOVE], 'hh:mm:ss tt') as TIME,[USER_MOVE] 
