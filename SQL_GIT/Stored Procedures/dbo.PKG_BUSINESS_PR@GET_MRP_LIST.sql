...
BEGIN TRY
		BEGIN
			...
			SELECT 
				...
				SP.IMAGE,
				MRP.UNIT,
				MRP.UNIT + '= ' + CAST(SUNIT.RATE AS NVARCHAR) + ' ' + SUNIT.[UNIT_CODE_MIN] AS RATE,
			...
			LEFT JOIN   (
			 ...
			 LEFT JOIN [dbo].[EWIP_SPAREPART_UNIT] SUNIT ON SP.CODE = SUNIT.[SPARE_PART_CODE] AND SP.SP_DEPT_CODE = SUNIT.[DEPT_CODE] AND MRP.UNIT = SUNIT.[UNIT_CODE]
