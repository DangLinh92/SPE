CREATE TABLE [dbo].[EWIP_SPAREPART_LOCATION_TRANSACTION_NG]
(
...
GO
ALTER TABLE [dbo].[EWIP_SPAREPART_LOCATION_TRANSACTION_NG] ADD CONSTRAINT [PK_EWIP_SPAREPART_LOCATION_TRANSACTION_NG] PRIMARY KEY CLUSTERED ([ID]) ON [PRIMARY]
GO
